                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-colors ${
                          page === p
                            ? 'bg-navy-900 text-white shadow-xs dark:bg-sky-500 dark:text-slate-950'
          ...
          <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-2xl shadow-xl border border-gray-100 dark:border-slate-800 overflow-hidden flex flex-col max-h-[90vh] my-auto">
            <div className="flex items-center justify-between p-6 pb-4 border-b border-gray-100 dark:border-slate-800 flex-shrink-0">
              <div className="flex items-center space-x-3 text-amber-600 dark:text-amber-400">
                ...
                <h3 className="text-lg font-bold text-navy-950 dark:text-white">Confirm Deactivation</h3>
              </div>
              <button
                onClick={() => {
                  setIsDeleteConfirmOpen(false);
            ...
            <div className="p-6 overflow-y-auto flex-1">
              <p className="text-sm text-gray-500 dark:text-slate-300">
                Are you sure you want to deactivate <span className="font-bold text-navy-950 dark:text-white">{teacherToDelete?.userId?.name}</span>? This is a soft delete and will disable their account login. This can be reversed by an admin later.
              </p>
            </div>
            <div className="flex items-center justify-end space-x-3 p-4 px-6 border-t border-gray-100 dark:border-slate-800 bg-gray-50 dark:bg-slate-900/60 flex-shrink-0">
              <button
                onClick={() => {
                  setIsDeleteConfirmOpen(false);
                  setTeacherToDelete(null);
                }}
                className="px-4 py-2 border border-gray-200 dark:border-slate-700 text-gray-500 dark:text-slate-300 rounded-xl text-sm font-semibold hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors"
              >
                Cancel
              </button>
              <button
