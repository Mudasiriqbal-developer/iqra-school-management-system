...
import SetCustomFeeModal from '../features/students/SetCustomFeeModal';
...
const AdminStudents = () => {
  ...
  return (
    ...
    >
      ...
      <SetCustomFeeModal
        isOpen={isCustomFeeModalOpen}
        student={studentForCustomFee}
        feeMode={feeMode}
        setFeeMode={setFeeMode}
        customFeeAmount={customFeeAmount}
        setCustomFeeAmount={setCustomFeeAmount}
        customFeeNote={customFeeNote}
        setCustomFeeNote={setCustomFeeNote}
        isSubmitting={isSubmittingCustomFee}
        onSubmit={handleCustomFeeSubmit}
        onClose={() => {
          setIsCustomFeeModalOpen(false);
          setStudentForCustomFee(null);
        }}
